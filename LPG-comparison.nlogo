...
to go
  ...
  if (ticks >= 500 or count(players) < 3) [stop]
...
to-report borda-count-Pitt
  ...
  (foreach t-equality-allocation (range (count(players) ) 0 -1)
    ...
    ; borda points for f_1c: the canon of equality
  (foreach t-equality-rounds (range (count(players) ) 0 -1)
    [ [agent f_1c-points] -> ask agent [set borda-points borda-points + (w1c * f_1c-points)]])
...
;#############################################################################
  ...
  (foreach t-equality-rounds (sort-on [(- borda-points)] players)
    [[x y] -> if (([t-who] of x) != ([t-who] of y)) [set hamming-w1c (hamming-w1c + 1)]])
...
allocation-method
allocation-method
"legitimate-claims-S0" "legitimate-claims" "legitimate-claims-evolutionary" "ostrom-random-allocation" "greedy-random-allocation" "equal-allocation" "legitimate-claims-fixed-pitt" "max-min-allocation" "legitimate-claims-Pitt"
8
...
@#$#@#$#@
<experiments>
  <experiment name="Scenario 1 -LPG - SO (Beta 0.6)" repetitions="50" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="Scenario 3 -LPG - LegitimateClaims- SO - Demand" repetitions="50" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 3 -LPG - LegitimateClaims- SO -Apropriation" repetitions="50" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 3 -LPG - LegitimateClaims-SO-Provision" repetitions="50" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 3 -LPG - LegitimateClaims- FixedPitt - Demand" repetitions="50" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 3 -LPG - LegitimateClaims- FixedJuan - Demand" repetitions="200" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 3 -LPG - LegitimateClaims- FixedPitt - Provision" repetitions="500" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 3 -LPG - LegitimateClaims- S0-Pitt - Demand" repetitions="200" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 3 -LPG - LegitimateClaims- FixedJuan - Demand" repetitions="500" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 3 -LPG - LegitimateClaims- FixedJuan - Provision" repetitions="500" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 3 -LPG - LegitimateClaims- S0-Pitt - Provision" repetitions="200" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
