...
to perform-allocation ;;turtle procedure
  ...
  if allocation-method = "legitimate-claims-evolutionary" [legitimate-claims-evolutionary]
end
...
to legitimate-claims-S0
  ...
  let r1 resource-1 ; temporal variable that represents the current value of the resource-1
  select-prosumer
  select-head
...
to-report borda-count-evolutionary
...
;##################################################################################
  ...
  let bbb borda-count-evolutionary
  ;show bbb
...
;##################################################################################
  ...
  while[k < population-size][
   ...
   matrix:set fitness-population k 0  (mean( [satisfaction-level] of players with [cheat-on = false]))
   set k (k + 1)
  ]
...
;##################################################################################
 ...
 ;let mut random population-size
 ;let new-feature random-float
...
360
avg-utility-NC
mean( [utility / ticks] of players with [cheat-on = true])
4
1
11
...
360
avg-utility-C
mean( [utility / ticks] of players with [cheat-on = false])
4
1
11
...
<experiments>
  ...
  <experiment name="Scenario 2-PD-demand" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="Scenario 4 PD GA (beta 0.4)" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 4 PD GA (beta 0.6)" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 4 PD GA (beta 0.1)" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 4 PD GA (beta 0.2)" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 4 PD GA (beta 0.3)" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
  ...
  <experiment name="Scenario 4 PD GA (beta 0.5)" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>precision (gini-index) 4</metric>
    <metric>precision (mean( [utility / ticks] of players with [cheat-on = false])) 4</metric>
